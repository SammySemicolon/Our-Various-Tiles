...
public class VariousItems
{
    ...
    public static final RegistryObject<Item> SOULSAND_BRICKS = ITEMS.register("soulsand_bricks", () -> new BlockItem(VariousBlocks.SOULSAND_BRICKS.get(), DEFAULT_PROPERTIES()));
    public static final RegistryObject<Item> SOULSAND_BRICKS_STAIRS = ITEMS.register("soulsand_bricks_stairs", () -> new BlockItem(VariousBlocks.SOULSAND_BRICKS_STAIRS.get(), DEFAULT_PROPERTIES()));
    public static final RegistryObject<Item> SOULSAND_BRICKS_SLAB = ITEMS.register("soulsand_bricks_slab", () -> new BlockItem(VariousBlocks.SOULSAND_BRICKS_SLAB.get(), DEFAULT_PROPERTIES()));
    public static final RegistryObject<Item> SOULSAND_BRICKS_WALL = ITEMS.register("soulsand_bricks_wall", () -> new BlockItem(VariousBlocks.SOULSAND_BRICKS_WALL.get(), DEFAULT_PROPERTIES()));
